...
class ProjectsViewModel(val firebase: FirestoreUtil, application: Application) : AndroidViewModel(application) {
    ...
    private val _projectData = MutableLiveData<List<Project>>()

    val postData: LiveData<List<Project>>
        get() = _projectData
    ...
    init {
        getProjectDataFromFirestore()
    }

    fun getProjectDataFromFirestore() =
        coroutineScope.launch {
            firebase.getProjectListener().observeForever { data ->
